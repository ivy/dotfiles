...
allowed-tools:
  ...
  - Grep
  - Glob
  # Deliberately not pre-approved: Write, Edit, MultiEdit. The skill performs them; none is auto-allowed.
---

# Documentation Skill (Diátaxis Framework)

**Autonomy:** model-invocable · acts autonomously — writes and edits docs in the working tree without confirmation
...
**Otherwise, answer both compass questions from the content and select the type:**
