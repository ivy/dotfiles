...
- **detect-private-key**: Triggers false positives on reference docs, repo-to-text dumps, and vendored text files that mention "PRIVATE KEY" in documentation. Exclude directories like `docs/reference/`, `vendor/`, or any large text dump directories.
...
// Detect private keys — exclude reference docs (vendored dumps mention keys)
