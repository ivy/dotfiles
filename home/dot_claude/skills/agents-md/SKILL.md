...
**Autonomy:** model-invocable · acts autonomously — writes AGENTS.md and repoints the CLAUDE.md symlink in the target repo; every change is local and git-visible
