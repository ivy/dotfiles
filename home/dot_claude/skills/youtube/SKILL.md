...
**Autonomy:** model-invocable · acts autonomously — writes the note under `Reference/` and deletes the temp transcript · asks only for a video URL the invocation omits
